/*
    Copyright 2013-2022, Strategic Gains, Inc.
...
implements Comparable<Identifier>
{
	...
	/**
	 * Stream the components of this identifier.
	 * 
	 * @return a Stream<Object> over the components of this identifier.
	 */
	...
	public String toString()
	{
		...
		return (components.size() == 1 ? firstComponent().toString() : String.format("(%s)", Identifier.toSeparatedString(this, TO_STRING_SEPARATOR)));
	}
	 ...
	 * 
	 * @return the last component of the identifier or null.
	 */
	...
	{
		return id.stream().map(Object::toString).collect(Collectors.joining(separator));
	}
